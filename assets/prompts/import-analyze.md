...
- `knowledge_updates[].action` ∈ establish / learn / reveal_to_reader；正文明确确立客观真相时用 `establish`，正文明确让角色获知已有真相时才用 `learn`，正文明确向读者揭示完整 Truth 时才用 `reveal_to_reader`。三者彼此独立；不要把一般世界设定、模糊暗示或伏笔部分兑现自动当成角色已知或完整读者揭示。
